...
export const DASHBOARDS: DashboardPanel[] = [
  ...
  { title: "OBP Breakdown", metricIds: ["obp", "obp_stall_m", "obp_stall_e", "obp_waste_m", "obp_waste_e", "obp_idle_bp", "obp_bp_capacity"],
    note: "OBP v3: alive-gated (dead frames excluded) with six components (incl. idle-BP and BP-capacity vs the 40-BP-per-m/s guide ratio) — the leak curves are cumulative violation fractions (best viewed one player at a time)." },
