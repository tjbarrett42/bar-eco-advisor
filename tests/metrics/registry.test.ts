...
describe("registry", () => {
  it("has unique ids and required raw metrics", () => {
    ...
    for (const id of ["m_income", "e_income", "m_excess", "e_excess", "mm_use", "mm_level", "m_sent", "m_received", "e_sent", "units_alive", "obp_idle_bp", "obp_bp_capacity", "extraction_t1", "extraction_t2", "mm_use_rec", "mm_capacity_rec", "bp_available", "bp_used", "bp_used_eco", "bp_used_army", "bp_used_defense", "bp_used_bp", "stall_sync", "ratio_balance", "ratio_share_bp", "ratio_share_m", "ratio_share_e"])
